...
public class MatchDetailEntity {
    ...
    private int radiant_captain;
    private int dire_captain;
    ...
    public int getRadiant_captain() {
        return radiant_captain;
    }

    public void setRadiant_captain(int radiant_captain) {
        this.radiant_captain = radiant_captain;
    }

    public int getDire_captain() {
        return dire_captain;
    }

    public void setDire_captain(int dire_captain) {
